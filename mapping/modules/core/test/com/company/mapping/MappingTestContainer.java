...
public class MappingTestContainer extends TestContainer {

    public MappingTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/mapping/app.properties",
    ...
    public static class Common extends MappingTestContainer {

        public static final MappingTestContainer.Common INSTANCE = new MappingTestContainer.Common();
