...
public class PracticTestContainer extends TestContainer {

    public PracticTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/practic/app.properties",
    ...
    public static class Common extends PracticTestContainer {

        public static final PracticTestContainer.Common INSTANCE = new PracticTestContainer.Common();
